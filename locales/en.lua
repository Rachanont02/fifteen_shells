Locales ['en'] = {
  -- weed
  ['fifteen_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~y~Cockles~s~.',
  ['fifteen_inventoryfull'] = 'you do not have any more inventory space for ~y~Cockles~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Cockles~s~.',
  ['weed_processingstarted'] = 'processing ~g~Cockles~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Cockles~s~ in order to process.',
  ...
  -- blips
  ['blip_shellfield'] = 'Cockles Field',
  ['blip_weedprocessing'] = 'Cockles Processing',
  ['blip_drugdealer'] = 'Cockles Dealer',
}
